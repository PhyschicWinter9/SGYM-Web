<php? header( '' refresh: 5; location:index.php'' ); ?>
  ...
  <head>
    ...
    <title>ลงชื่อเข้าใช้สำเร็จ</title>
    <!-- Bs js  -->
    ...
    <div class="row">
      ...
      <div class="col-4 text-center ">
        <div class="justify-content-center " style="margin-top: 20px; ">
          <img src="img/correct.gif" alt="correct" width="200px" height="200px"><br>
          <h3 class="alert-correct">ลงชื่อเข้าใช้สำเร็จ</h3>

          <a href="login.php"><button style="margin-bottom: 10px;" class="btn btn-dark btn-lg">ดำเนินการต่อ</button></a>
        </div>
      </div>
      <div class="col-4"></div>
    </div>
